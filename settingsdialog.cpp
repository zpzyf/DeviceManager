    ...
    ui(new Ui::SettingsDialog)
{
    ...
    intValidator = new QIntValidator(0, 4000000, this); //在0~4000000整形数值范围内的字符串都有效，比如-1或4000001无效


    ui->baudRateBox->setInsertPolicy(QComboBox::NoInsert);  //设置插入方法,字符串不会被插入到组合框
